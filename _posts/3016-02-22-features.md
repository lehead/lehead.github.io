...
The site comes with some default pages with permalinks: blog, works,
...
shows up in the center of the landing page along with the blog and works
pages. Note that the blog and works pages are special, each listing all
...
in addition to top of the blog listing.

{% include post_picwrap.html pos="right" src="/images/feature5.png" %}
On the blog page, underneath the featured blog, the blog are listed
by year.
...
You can group related blog together into the same category. These grouped
blog are ordered by date as usual but are also provided with Back
and Next links.
...
the [Elements]({{ '/blog/elements.html' | prepend: site.baseurl }}) page.
